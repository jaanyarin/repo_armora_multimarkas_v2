...
- Path: `/app/productos/crear-producto`
- Origen detección: `initial dom`

## Texto visible

```text
Personal: ALEJANDRO ANYARIN Lista Precios: LISTA DE PRECIO M1P Almacen: BROCKER MESA 1 Home Logout Compras Proveedores Preventas Ventas Notas de Credito Informes Cambios de Productos Canjes de Productos Sunat Resumenes Diarios Comunicacion de Baja Requerimientos Liquidaciones Personal Mapas de Rutas Clientes Zonas y Rutas Almacenes Unidades de Trans. Premios Canjes Productos Servicios Combos de Productos Concursos Comisiones Cobertura Listas de Precios Vendedor Configuracion Transportistas General Crear Producto Clase Seleccione una clase Subclase Seleccione una subclase Unidad de Medida Display SKU Nombre Elementos Caja Elementos Unidad Orden Reporte Valor Flete Precio Compra Referencial Peso total kg Segmento Sunat Seleccione una unidad Familia Sunat Seleccione una unidad Clase Sunat Seleccione una unidad Clasificacion Sunat Seleccione una unidad Afeccion IGV Gravado - Operación Onerosa Comerciable Afecto ISC Almacen Stock Minimo Stock Maximo Alertas Stock BROCKER MESA 1 Habilitado BROCKER MESA 2 Habilitado FALTANTE INVENTARIOS Habilitado PRODUCTOS EN MAL ESTADO Habilitado Crear Producto
```
...
Archivo HTML: `app_productos_crear-producto__crear_producto.html`

## Screenshot

Archivo PNG: `app_productos_crear-producto__crear_producto.png`
