# Reportes de Listas de Precios

## Endpoint

- URL: `https://armorasac.com/app/lista-precios/reportes-listas-precios`
- Path: `/app/lista-precios/reportes-listas-precios`
- Origen detección: `initial dom`

## Texto visible

```text
Personal: ALEJANDRO ANYARIN Lista Precios: LISTA DE PRECIO M1P Almacen: BROCKER MESA 1 Home Logout Compras Proveedores Preventas Ventas Notas de Credito Informes Cambios de Productos Canjes de Productos Sunat Resumenes Diarios Comunicacion de Baja Requerimientos Liquidaciones Personal Mapas de Rutas Clientes Zonas y Rutas Almacenes Unidades de Trans. Premios Canjes Productos Servicios Combos de Productos Concursos Comisiones Cobertura Listas de Precios Vendedor Configuracion Transportistas General Reportes de Listas de Precios Lista de Precios [Completo] Productos y Combos correspondientes a la lista de precios seleccionada. Seleccione una lista precios Generar Reporte Lista de Precios [Simple] Productos y Combos correspondientes a la lista de precios seleccionada. Seleccione una lista precios Generar Reporte
```
...
Archivo HTML: `app_lista-precios_reportes-listas-precios__reportes_de_listas_de_precios.html`

## Screenshot

Archivo PNG: `app_lista-precios_reportes-listas-precios__reportes_de_listas_de_precios.png`
