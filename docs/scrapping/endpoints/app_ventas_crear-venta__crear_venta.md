...
```json
{
  "top_colors": [
    ...
    {
      "color": "rgba(0, 0, 0, 0.6) rgba(0, 0, 0, 0.6) rgba(0, 0, 0, 0.6) rgba(34, 36, 38, 0.15)",
      "count": 2
    },
    {
...
Archivo HTML: `app_ventas_crear-venta__crear_venta.html`

## Screenshot

Archivo PNG: `app_ventas_crear-venta__crear_venta.png`
