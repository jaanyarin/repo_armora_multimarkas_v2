...
- Path: `/app/clientes/crear-cliente`
- Origen detección: `initial dom`

## Texto visible

```text
Personal: ALEJANDRO ANYARIN Lista Precios: LISTA DE PRECIO M1P Almacen: BROCKER MESA 1 Home Logout Compras Proveedores Preventas Ventas Notas de Credito Informes Cambios de Productos Canjes de Productos Sunat Resumenes Diarios Comunicacion de Baja Requerimientos Liquidaciones Personal Mapas de Rutas Clientes Zonas y Rutas Almacenes Unidades de Trans. Premios Canjes Productos Servicios Combos de Productos Concursos Comisiones Cobertura Listas de Precios Vendedor Configuracion Transportistas General Cliente Opcionales Persona Puede realizar boletas y facturas Empresa Sólo puede realizar facturas Nombre Completo Zona Seleccione una zona Ruta Seleccione una ruta Secuencia Documento DNI Día de Atención Lunes Tipo de Negocio Seleccione un negocio Dirección Crear Cliente
```
...
Archivo HTML: `app_clientes_crear-cliente__crear_cliente.html`

## Screenshot

Archivo PNG: `app_clientes_crear-cliente__crear_cliente.png`
