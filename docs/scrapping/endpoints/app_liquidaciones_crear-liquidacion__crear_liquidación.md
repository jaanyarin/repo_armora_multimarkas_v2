...
- Path: `/app/liquidaciones/crear-liquidacion`
- Origen detección: `initial dom`

## Texto visible

```text
Personal: ALEJANDRO ANYARIN Lista Precios: LISTA DE PRECIO M1P Almacen: BROCKER MESA 1 Home Logout Compras Proveedores Preventas Ventas Notas de Credito Informes Cambios de Productos Canjes de Productos Sunat Resumenes Diarios Comunicacion de Baja Requerimientos Liquidaciones Personal Mapas de Rutas Clientes Zonas y Rutas Almacenes Unidades de Trans. Premios Canjes Productos Servicios Combos de Productos Concursos Comisiones Cobertura Listas de Precios Vendedor Configuracion Transportistas General Liquidación por Comprobantes Liquidación por Vendedores Liquidación por Requerimiento Crear Liquidación Transportista Seleccione una transportista Unidad de Transporte Seleccione un transporte Fecha de Ventas Almacen Seleccione un almacen Lista de Precios Seleccione una lista Listar Ventas Mostrando 10 Lote Emision Zona: Ruta Cliente Vendedor Venta Devol Total No hay datos disponibles Crear Liquidación
```
...
[
  ...
  },
  {
    ...
    "headers": [],
    "rows_text": [
      "Lote Emision Zona: Ruta Cliente Vendedor Venta Devol Total"
    ],
    "row_count": 1
  },
  {
    ...
    "headers": [],
    "rows_text": [
      "Fecha VentasCódigoLista PreciosAlmacenTransportistaTotal"
    ],
    "row_count": 1
  }
]
...
```json
{
  "top_colors": [
    ...
    {
      "color": "rgba(34, 36, 38, 0.1) rgba(40, 40, 40, 0.3) rgba(40, 40, 40, 0.3) rgba(34, 36, 38, 0.1)",
      "count": 48
    },
    {
    ...
    {
      "color": "rgba(40, 40, 40, 0.3) rgba(40, 40, 40, 0.3) rgba(40, 40, 40, 0.3) rgba(34, 36, 38, 0.1)",
      "count": 10
    },
    {
    ...
    {
      "color": "rgba(34, 36, 38, 0.15) rgba(34, 36, 38, 0.15) rgba(34, 36, 38, 0.15) rgba(0, 0, 0, 0)",
      "count": 1
    },
    {
...
Archivo HTML: `app_liquidaciones_crear-liquidacion__crear_liquidación.html`

## Screenshot

Archivo PNG: `app_liquidaciones_crear-liquidacion__crear_liquidación.png`
