...
- Path: `/app/clientes/reportes-clientes`
- Origen detección: `initial dom`

## Texto visible

```text
Personal: ALEJANDRO ANYARIN Lista Precios: LISTA DE PRECIO M1P Almacen: BROCKER MESA 1 Home Logout Compras Proveedores Preventas Ventas Notas de Credito Informes Cambios de Productos Canjes de Productos Sunat Resumenes Diarios Comunicacion de Baja Requerimientos Liquidaciones Personal Mapas de Rutas Clientes Zonas y Rutas Almacenes Unidades de Trans. Premios Canjes Productos Servicios Combos de Productos Concursos Comisiones Cobertura Listas de Precios Vendedor Configuracion Transportistas General Reportes Clientes Clientes por Zona Lista los clientes por zona y ruta seleccionadas. Zona Seleccione una zona Ruta Seleccione una ruta Formato PDF Generar Reporte Clientes por Personal Lista los clientes por el personal seleccionado. PDF Seleccione una persona Generar Reporte Ficha Cliente Ficha con los datos del cliente seleccionado. Código Generar Reporte
```
...
Archivo HTML: `app_clientes_reportes-clientes__reportes_de_clientes.html`

## Screenshot

Archivo PNG: `app_clientes_reportes-clientes__reportes_de_clientes.png`
