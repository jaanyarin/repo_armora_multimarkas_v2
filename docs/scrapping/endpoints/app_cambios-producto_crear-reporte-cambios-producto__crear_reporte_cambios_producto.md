# Crear Reporte Cambios Producto

## Endpoint

- URL: `https://armorasac.com/app/cambios-producto/crear-reporte-cambios-producto`
- Path: `/app/cambios-producto/crear-reporte-cambios-producto`
- Origen detección: `initial dom`

## Texto visible

```text
Personal: ALEJANDRO ANYARIN Lista Precios: LISTA DE PRECIO M1P Almacen: BROCKER MESA 1 Home Logout Compras Proveedores Preventas Ventas Notas de Credito Informes Cambios de Productos Canjes de Productos Sunat Resumenes Diarios Comunicacion de Baja Requerimientos Liquidaciones Personal Mapas de Rutas Clientes Zonas y Rutas Almacenes Unidades de Trans. Premios Canjes Productos Servicios Combos de Productos Concursos Comisiones Cobertura Listas de Precios Vendedor Configuracion Transportistas General Requerimientos Cambios Liquidaciones Cambios Crear por Seleccion Crear por Vendedores Transportista ALEJANDRO ANYARIN Unidad de Transporte [BEZ-933] ZB5023XXYADB3F T-KING Almacen Seleccione un almacen Fecha de Entrega Buscar Documentos Mostrando 10 Codigo Fecha Zona: Ruta Cliente Vendedor No hay datos disponibles Crear Requerimiento
```
...
[
  ...
  },
  {
    ...
    "headers": [],
    "rows_text": [
      "Codigo Fecha Zona: Ruta Cliente Vendedor"
    ],
    "row_count": 1
  },
  {
    ...
    "headers": [],
    "rows_text": [
      "CodigoFechaZona: RutaClienteVendedor"
    ],
    "row_count": 1
  },
  {
    ...
    "headers": [],
    "rows_text": [
      "CodigoFechaAlmacenTransportistaCantidad"
    ],
    "row_count": 1
  }
]
...
Archivo HTML: `app_cambios-producto_crear-reporte-cambios-producto__crear_reporte_cambios_producto.html`

## Screenshot

Archivo PNG: `app_cambios-producto_crear-reporte-cambios-producto__crear_reporte_cambios_producto.png`
