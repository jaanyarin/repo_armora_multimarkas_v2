...
- Path: `/app/almacenes/gestion-almacenes`
- Origen detección: `initial dom`

## Texto visible

```text
Personal: ALEJANDRO ANYARIN Lista Precios: LISTA DE PRECIO M1P Almacen: BROCKER MESA 1 Home Logout Compras Proveedores Preventas Ventas Notas de Credito Informes Cambios de Productos Canjes de Productos Sunat Resumenes Diarios Comunicacion de Baja Requerimientos Liquidaciones Personal Mapas de Rutas Clientes Zonas y Rutas Almacenes Unidades de Trans. Premios Canjes Productos Servicios Combos de Productos Concursos Comisiones Cobertura Listas de Precios Vendedor Configuracion Transportistas General Gestión de Almacenes Mostrando 10 Código Nombre Alerta Stock Acciones ALM200900001 BROCKER MESA 1 HABILITADO ALM241100001 BROCKER MESA 2 HABILITADO ALM210900001 FALTANTE INVENTARIOS HABILITADO ALM210400001 PRODUCTOS EN MAL ESTADO HABILITADO 4 resultados de 4 1
```
...
[
  ...
  },
  {
    ...
    "headers": [],
    "rows_text": [
      "Código Nombre Alerta Stock Acciones",
      "ALM200900001 BROCKER MESA 1 HABILITADO",
      "ALM241100001 BROCKER MESA 2 HABILITADO",
      "ALM210900001 FALTANTE INVENTARIOS HABILITADO",
      "ALM210400001 PRODUCTOS EN MAL ESTADO HABILITADO"
    ],
    "row_count": 5
  }
]
...
Archivo HTML: `app_almacenes_gestion-almacenes__gestión_almacenes.html`

## Screenshot

Archivo PNG: `app_almacenes_gestion-almacenes__gestión_almacenes.png`
